...
def test_data_fetching():
    ...
    data = fetcher.fetch_yfinance("BTC-USD", start_date="2024-01-01", end_date="2024-02-01")
    ...
    if data is not None:
        ...
        factory = StrategyFactory()
        strategy = factory.create_strategy("moving_average_cross", {"fast_period": 5, "slow_period": 10})
...
def test_backtest_engine():
    ...
    if strategy:
        ...
        if results:
            ...
            print(f"Total return: {results['stats'].get('formatted', {}).get('Total Return', 'N/A')}")
        else:
