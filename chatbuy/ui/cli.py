...
class ChatBuyCLI:
    ...
    def process_strategy_request(self, user_input: str) -> None:
        ...
        with Progress(
            ...
            if strategy_config is None:
                self.console.print(
                    "[red]❌ Could not understand your strategy description[/red]"
                )
                self.show_examples()
                return
            ...
            strategy = self.strategy_factory.create_strategy(
                strategy_config["strategy_type"], strategy_config["parameters"]
            )
