...
class BitcoinEnv:  # custom env
    """A custom environment for simulating Bitcoin trading with reinforcement learning.

    This environment allows agents to buy and sell Bitcoin based on price and technical indicators.
    It supports different modes (train, test, trade) and tracks performance metrics.
    """
    def __init__(
        self,
        data_cwd=None,
