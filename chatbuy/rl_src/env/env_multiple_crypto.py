...
class CryptoEnv:  # custom env
    """A custom environment for simulating cryptocurrency trading with reinforcement learning.

    This environment supports multiple cryptocurrencies, tracks performance metrics, and allows agents
    to make buy and sell decisions based on price and technical indicators.
    """
    def __init__(
        self,
        config,
